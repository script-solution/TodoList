...
$LANG['error']['chmod_install'] = 'Setze bitte den CHMOD des Verzeichnisses "install" auf 0777';
$LANG['error']['chmod_install_config'] = 'Setze bitte den CHMOD der Datei "install/user_config.php" auf 0666';
...
$LANG['error']['board_url'] = 'Bitte gib den TodoList-Pfad an.';
...
$LANG['board_url_desc'] = 'Die absolute URL zu Deiner TodoList. D.h., wenn die TodoList z.B. hier liegt: "http://www.domain.de/todolist/index.php", dann w&auml;re die URL: "http://www.domain.de/todolist"<br />
Wichtig ist, dass der letzte "/" nicht angegeben wird.';
$LANG['table_praefix'] = 'Tabellen-Pr&auml;fix';
$LANG['btn_update'] = 'Aktualisieren';

$LANG['table_exists_error'] = 'Wenn Du eine Neuinstallation durchf&uuml;hren willst, darf keine Tabelle bereits vorhanden sein.<br />Falls Du die TodoList ein weiteres Mal in dieser Datenbank installieren willst oder aus anderen Gr&uuml;nden die selbe Datenbank nutzen m&ouml;chtest, kannst Du oben auf dieser Seite das "Tabellen-Pr&auml;fix" ver&auml;ndern.';
